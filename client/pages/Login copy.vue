    ...
    <div class="login-page-inner">
      ...
      <el-form :model="formData" :rules="formRules" ref="loginForm" label-width="0px">
        ...
        <el-form-item prop="password">
          <el-input v-model="formData.password" name="password" placeholder="请输入密码" :type="inputType"
      ...
      <p class="login-page-bottom">Copyright © 2020 <span class="primary">慧集互联版权所有</span></p>
    </div>
